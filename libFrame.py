...
class MicroSwitchTester:
    ...
    def __init__(self, root):
        ...
        frame = ttk.Frame(mainframe, borderwidth=5, relief="sunken", width=w, height=h, style = 'My.TFrame')
        ttk.Label(mainframe, text='MicroSwitch Tester', font = "Verdana 40 bold italic", style = 'My.TLabel').grid(column=0, row=0, columnspan=3, rowspan=4, sticky = W)
